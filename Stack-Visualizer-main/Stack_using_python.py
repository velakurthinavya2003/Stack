...
class StackVisualizer:
      def __init__(self, root):
          ...
          self.number_set_x = 350
          self.number_set_y = 105
          self.block_left = 350
          self.block_right =600
          self.block_up = 100
          self.block_down = 130
      ...
      def heading_and_sub_heading(self): #Main heading, sub heading and indicator label set
          self.heading_name = Label(self.stack_canvas, text="Stack Visualizer", bg="white", fg="blue", font=("Helvetica",30,"bold","italic"))
          self.heading_name.place(x=350,y=30)

          self.sub_heading = Label(self.stack_canvas, text="Index Number", bg="white", fg="blue",  font=("Helvetica",20,"bold","italic"))
          self.sub_heading.place(x=50,y=300)

          self.stack_indicator = Label(self.stack_canvas, text="Stack Container", bg="white", fg="black",  font=("Helvetica",20,"bold","italic"))
          self.stack_indicator.place(x=350,y=450)
      ...
      def make_buttons(self): #Make Buttons to access and make top with arrow
          ...
          self.push_btn.place(x=20,y=535)

          self.pop_btn = Button(self.window, text="POP", fg="White", bg="black", font=("Arial", 15, "bold"),
                                relief=RAISED,bd=7,command=self.pop_data)
          self.pop_btn.place(x=910, y=535)

          self.top_index = Label(self.window, text="<---- top", fg="black", bg="white", font=("Arial", 20, "bold"))
          self.top_index.place(x=650, y=self.top_y)

      def make_stack_container(self): #Making of stack container
          self.stack_canvas.create_line(345,200,345,400,fill="grey",width=8)
          self.stack_canvas.create_line(345,400,600,400,fill="grey",width=8)
          self.stack_canvas.create_line(600, 200, 600, 400, fill="grey", width=8)

      def set_index(self): #Index of the stack set
          self.index_neg = Label(self.stack_canvas,text="-1",fg="black",bg="white",font=("Arial",15,"bold"))
          self.index_neg.place(x= 315, y=403)

          self.index_0 = Label(self.stack_canvas, text="0", fg="black", bg="white", font=("Arial", 15, "bold"))
          self.index_0.place(x=320, y=365)

          self.index_1 = Label(self.stack_canvas, text="1", fg="black", bg="white", font=("Arial", 15, "bold"))
          self.index_1.place(x=320, y=332)

          self.index_2 = Label(self.stack_canvas, text="2", fg="black", bg="white", font=("Arial", 15, "bold"))
          self.index_2.place(x=320, y=299)

          self.index_3 = Label(self.stack_canvas, text="3", fg="black", bg="white", font=("Arial", 15, "bold"))
          self.index_3.place(x=320, y=266)

          self.index_4 = Label(self.stack_canvas, text="4", fg="black", bg="white", font=("Arial", 15, "bold"))
          self.index_4.place(x=320, y=232)

          self.index_5 = Label(self.stack_canvas, text="5", fg="black", bg="white", font=("Arial", 15, "bold"))
          self.index_5.place(x=320, y=199)
      ...
      def push_element(self): #Push button action
          if len(self.last_label_value_keep) == 6:
             messagebox.showerror("  Overflow  ","  Stack is full   ")
              ...
              self.add_btn = Button(self.window, text="Add", font=("Arial", 10, "bold"), bg="blue", fg="white", relief=RAISED, bd=3, padx=3, pady=3, command=lambda: self.make_block('<Return>'))
      ...
      def make_block(self,e):#Element containing block making
          try:
              ...
              self.block_make = self.stack_canvas.create_rectangle(self.block_left, self.block_up, self.block_right, self.block_down, fill="black", width=8, outline="blue")
              self.entry_number = Label(self.stack_canvas, textvar=self.number, bg="black", fg="white", font=("Arial",11,"bold"),width=8)
      ...
      def reset_with_position_set(self): #Reset the coordinate value
          ...
          self.final_set_block = Label(self.window, text=self.value_entry.get(), bg="black", fg="white",font=("Arial",11,"bold"))
